    ...
    public function run()
    {
        ...
        DB::table('campsites')->insert([
            ...
            [
                ...
                "postcode" => "HR2 8EU",
                "amenities" => "toilets, drinking water, fire pits, barbeque",
                "rating" => 2,
            ...
            [
                ...
                "postcode" => "HR1 4JA",
                "amenities" => "caravan power, caravan sites, pets welcome, showers, toilets, dump station",
                "rating" => 4,
            ...
            [
                ...
                "postcode" => "DY10 3PX",
                "amenities" => "tent sites, toilets, drinking water, picnic tables, playground",
                "rating" => 3,
            ...
            [
                ...
                "town_city" => "Malvern",
                "postcode" => "WR13 5AY",
                "amenities" => "showers, lounge, household power, barbeque, wheelchair access, wifi, toilets",
                "rating" => 5,
            ...
            [
                ...
                "postcode" => "LN12 2NU",
                "amenities" => "drinking water, barbeque, swimming pool, toilets, showers, kitchen",
                "rating" => 4,
            ...
            [
                ...
                "town_city" => "Matlock",
                "postcode" => "S45 0JS",
                "amenities" => "tent sites, picnic tables, pets welcome, drinking water",
                "rating" => 5,
            ...
            [
                ...
                "town_city" => "Mansfield",
                "postcode" => "NG21 9HW",
                "amenities" => "kitchen, cutlery & crockery, caravan sites, caravan power, wifi",
                "rating" => 3,
            ...
            [
                ...
                "town_city" => "Retford",
                "postcode" => "DN22 0PW",
                "amenities" => "showers, household power, lounge, cards accepted",
                "rating" => 2,
            ...
            [
                ...
                "postcode" => "IP12 4NR",
                "amenities" => "toilets, drinking water, fire pits, barbeque, playground, wifi",
                "rating" => 2,
            ...
            [
                ...
                "postcode" => "IP23 8HH",
                "amenities" => "caravan power, caravan sites, pets welcome, showers, toilets, dump station, kitchen, cutlery & crockery",
                "rating" => 4,
                "contact_no" => "01432890243",
            ...
            [
                ...
                "town_city" => "Thetford",
                "postcode" => "IP25 7PL",
                "amenities" => "tent sites, toilets, drinking water, picnic tables, playground, barbeque, fire pits",
                "rating" => 3,
            ...
            [
                ...
                "town_city" => "Norwich",
                "postcode" => "NR12 0AU",
                "amenities" => "showers, lounge, household power, barbeque, wheelchair access, wifi, toilets, swimming pool, laundry",
                "rating" => 5,
            ...
            [
                ...
                "town_city" => "Helston",
                "postcode" => "TR12 7NX",
                "amenities" => "Showers, toilets, cafe, kitchen, cutlery & crockery, wifi",
                "rating" => 5,
            ...
            [
                ...
                "town_city" => "Saint Austell",
                "postcode" => "PL26 7JL",
                "amenities" => "toilets, firepits, picnic tables, tent sites, pets welcome, barbeque, drinking water",
                "rating" => 4,
            ...
            [
                ...
                "town_city" => "Ilfracombe",
                "postcode" => "EX34 0AT",
                "amenities" => "Showers, toilets, picnic tables, fire pits, pets welcome",
                "rating" => 3,
            ...
            [
                ...
                "town_city" => "Wells",
                "postcode" => "BA5 1NN",
                "amenities" => "Toilets, swimming pool, laundry, lounge, playground",
                "rating" => 2,
